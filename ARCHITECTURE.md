...
- `internal/finance` implements consolidated member accounts, lifecycle-aware active/archived/deleted balance summaries, personal and anonymous group category statistics, permission-gated group and own-account incoming payments, payment reversal, recent ledger activity, and finance-management read models. Archived accounts remain settlement targets; deleted accounts are projected only while their current receivable is non-zero.
