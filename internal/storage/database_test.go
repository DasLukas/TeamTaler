...
func TestRemoveCategoryTypeMigrationPreservesExistingRows(t *testing.T) {
	...
	legacyStatements := []string{
		...
		`INSERT INTO schema_migrations(version) VALUES('0045_statistics_dashboard.sql')`,
...
func TestDynamicRoleMigrationBackfillsLegacyAccessAndDropsCategoryGrants(t *testing.T) {
	...
	if permissionCount != 15 || mainRoleCount != 5 || secondRoleCount != 4 {
		t.Fatalf("definitions/main roles/second roles = %d/%d/%d, want 15/5/4", permissionCount, mainRoleCount, secondRoleCount)
	}
