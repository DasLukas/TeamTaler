...
export const PERMISSION_IMPLICATIONS: Readonly<Partial<Record<PermissionKey, readonly PermissionKey[]>>> = {
  FINANCE_MANAGEMENT: ['MANAGE_EXTERNAL_ACCOUNTS'],
  MANAGE_EXTERNAL_ACCOUNTS: ['VIEW_EXTERNAL_ACCOUNTS'],
  ...
  CREATE_PLANNING_EVENTS: ['USE_PLANNING'],
  VIEW_PLANNING_PARTICIPANTS: ['USE_PLANNING'],
  MANAGE_PLANNING_EVENTS: ['USE_PLANNING', 'CREATE_PLANNING_EVENTS', 'VIEW_PLANNING_PARTICIPANTS'],
};
