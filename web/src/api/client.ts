...
export const api = {
  ...
  getMemberStatistics: async (groupId: string, query: StatisticsQuery): Promise<MemberStatistics> => adaptMemberStatistics(await request<unknown>(collectionPath(groupPath(groupId, 'statistics/members'), query))),
  getFinanceStatistics: async (groupId: string, query: StatisticsQuery): Promise<FinanceStatistics> => adaptFinanceStatistics(await request<unknown>(collectionPath(groupPath(groupId, 'statistics/finance'), query))),
