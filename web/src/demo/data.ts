...
const demoAdministratorGrants = grants('GROUP_ADMINISTRATION', 'MEMBER_MANAGEMENT', 'ROLE_MANAGEMENT', 'FINANCE_MANAGEMENT', 'CATALOG_MANAGEMENT', 'VIEW_MEMBER_DIRECTORY', 'VIEW_STATISTICS', 'VIEW_ALL_BOOKING_ACTIVITY', 'RECORD_OWN_PAYMENT', 'CREATE_OWN_BOOKING', 'VOID_OWN_BOOKING', 'VOID_ANY_BOOKING', 'BOOK_FOR_OTHERS', 'BOOK_FOR_GUESTS', 'USE_PLANNING', 'CREATE_PLANNING_EVENTS', 'VIEW_PLANNING_PARTICIPANTS', 'MANAGE_PLANNING_EVENTS');
...
export const demoSession: Session = {
  ...
  groups: [
    { id: 'group-sv-adler', name: 'SV Adler', currency: 'EUR', defaultTheme: 'TEAMTALER', statisticsEnabled: true, planningEnabled: true, membership: { id: 'member-lukas', roleIds: demoAdministratorRoleIds, effectiveGrants: demoAdministratorGrants, roles: ['ADMIN', 'MEMBER', 'FINANCE_MANAGER', 'CATALOG_MANAGER'], groupPermissions: ['SELF_RECORD_PAYMENT'], themeOverride: null } },
...
export const demoSettlements: Settlement[] = [
  { id: 'settlement-1', periodId: 'period-july', periodLabel: 'Juli 2026', periodStartsAt: '2026-07-01T00:00:00+02:00', periodClosedAt: '2026-08-01T08:00:00+02:00', membershipId: 'member-lukas', membershipStatus: 'ACTIVE', memberName: 'Lukas Waschul', email: 'lukas@example.test', amount: { minorUnits: '3200', currency: 'EUR' }, paidAmount: { minorUnits: '2000', currency: 'EUR' }, openAmount: { minorUnits: '1200', currency: 'EUR' }, dueAt: '2026-08-15', status: 'PARTIAL' },
  { id: 'settlement-2', periodId: 'period-july', periodLabel: 'Juli 2026', periodStartsAt: '2026-07-01T00:00:00+02:00', periodClosedAt: '2026-08-01T08:00:00+02:00', membershipId: 'member-mara', membershipStatus: 'ACTIVE', memberName: 'Mara Becker', email: 'mara@example.test', amount: { minorUnits: '1500', currency: 'EUR' }, paidAmount: { minorUnits: '1500', currency: 'EUR' }, openAmount: { minorUnits: '0', currency: 'EUR' }, dueAt: '2026-08-15', status: 'PAID' },
];
