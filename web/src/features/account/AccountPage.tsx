...
/**
 * Downloads a formula-safe account ledger as localized CSV.
 *
 * @param entries - Ledger rows to serialize.
...
/**
 * Renders the personal account statement with print and safe CSV export.
 *
 * @returns A localized account and settlement view.
 */
export function AccountPage() {
  ...
  if (ledgerQuery.isLoading || dashboardQuery.isLoading || settlementsQuery.isLoading) return <Page title={t('account.title')}><StatePanel kind="loading" /></Page>;
