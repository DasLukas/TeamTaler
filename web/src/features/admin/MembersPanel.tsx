        ...
        <div className={tableStyles.tableWrap}>
          <table className={tableStyles.table}>
            ...
            <tbody>{activeMembers.map((member) => <tr key={member.id}>
              <td><button className={`${styles.rowLink} ${styles.member}`} onClick={() => onOpenRights?.(member.id)} type="button"><Avatar name={member.displayName} /> <strong>{member.displayName}</strong></button></td>
